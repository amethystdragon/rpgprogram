...
public final class ChannelManager {
	...
	public boolean addSystemChannel(String name, String pass) {
		...
		if (systemChannels == null) {
			systemChannels = new Hashtable<String, ChannelManagerItem>();
		}
	...
	public String addUserChannel(String name, String pass, ClientConnection cc) {
		...
		if (userChannels == null) {
			userChannels = new Hashtable<String, ChannelManagerItem>();
		}
	...
	public Enumeration<String> enumerate() {
		...
		if (systemChannels != null) {
			Enumeration<String> e = systemChannels.keys();
			while (e.hasMoreElements()) {
				all.add(e.nextElement());
			}
		}
		if (userChannels != null) {
			Enumeration<String> e = userChannels.keys();
			while (e.hasMoreElements()) {
				all.add(e.nextElement());
			}
		}
