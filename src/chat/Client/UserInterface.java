...
public class UserInterface extends JFrame{
	...
	/**
	 * Default constructor for the user interface which initializes necessary variables and calls initializeUI()
	 */
	...
	/**
	 * Attempts to connect to a server and, if successful, will print all incoming messages to the message log.
	 */
	private void connectToServer()
	{
		try {
			//indicate to user attempting to connect at the specified IP and port
		...
		if(connected)
		{
			try {
				...
				//indicate the communication channels were successfully initialized
			...
			if (e.getSource().equals(connect))
			{
				if (!connected)
				{
					...
					try {
						...
						ip = InetAddress.getByName(JOptionPane.showInputDialog("Enter server IP address"));
